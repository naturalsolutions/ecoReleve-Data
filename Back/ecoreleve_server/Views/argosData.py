...
def type_unchecked_list(request):
    ...
    selectStmt = select([unchecked.c['FK_Sensor'], unchecked.c['FK_Individual'], unchecked.c['FK_ptt'], unchecked.c['StartDate'], unchecked.c['EndDate'],
    ...
    queryStmt = selectStmt.where(unchecked.c['checked'] == 0
            ).group_by(unchecked.c['FK_Sensor'], unchecked.c['FK_Individual'],unchecked.c['FK_ptt'], unchecked.c['StartDate'], unchecked.c['EndDate']
