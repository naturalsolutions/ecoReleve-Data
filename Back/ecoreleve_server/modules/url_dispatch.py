def includeme(config):
    ...
    config.add_route(
        'jsLog',
        'ecoReleve-Core/log/error'
        )

    # Security routes
    config.add_route(
        'security/login',
        'ecoReleve-Core/security/login'
        )
    config.add_route(
        'security/logout',
        'ecoReleve-Core/security/logout')
    config.add_route(
        'security/has_access',
    ...
    config.add_route(
        'autocomplete',
        'ecoReleve-Core/autocomplete/{obj}/{prop}'
        )
    config.add_route(
        'autocomplete/ID',
    ...
    config.add_route(
        'sensors/datas',
        'ecoReleve-Core/sensors/{type}/datas'
        )
    config.add_route(
        'sensors/uncheckedDatas',
        'ecoReleve-Core/sensors/{type}/uncheckedDatas'
        )
    config.add_route(
        'sensors/uncheckedDatas/id_indiv/ptt',
        'ecoReleve-Core/sensors/{type}/uncheckedDatas/{id_indiv}/{id_ptt}'
        )
    config.add_route(
        'sensors/statut',
        'ecoReleve-Core/sensors/{type}/statut'
        )
    config.add_route(
        'cameratrap',
        'ecoReleve-Core/photos/'
        )
    config.add_route(
        'getSessionZip',
        'ecoReleve-Core/photos/export/'
        )
